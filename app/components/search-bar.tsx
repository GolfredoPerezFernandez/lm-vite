...
import { UserCircleCreate } from "./user-circle-create"
...
export function SearchBar({ profile }: props) {
    ...
    return (
        <form className="w-full mt-40  justify-center items-center  px-6 flex  gap-x-4 border-b-4 border-b-blue-900 border-opacity-30 h-20">
           ...
           <UserCircle
            ...
            <div className={`flex items-center w-2/5`}>
                <input type="text" name="filter" className="flex w-full rounded-xl px-3 py-2" placeholder="Search a message or name" />
