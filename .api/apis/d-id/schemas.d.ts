                            ...
                            readonly anyOf: readonly [{
                                ...
                                readonly properties: {
                                    ...
                                    readonly model_id: {
                                        ...
                                        readonly default: "eleven_monolingual_v1";
                                        readonly examples: readonly ["eleven_monolingual_v1"];
                                    };
                                };
                                readonly required: readonly ["type", "voice_id"];
                                readonly type: "object";
    ...
    readonly response: {
        readonly "201": {
            readonly properties: {
                readonly session_id: {
                    readonly type: "string";
                    readonly description: "session identifier information, should be returned in the body of all streaming requests";
                };
                readonly id: {
                    readonly type: "string";
    ...
    readonly body: {
        readonly properties: {
            ...
            readonly driver_url: {
                ...
                readonly type: "string";
                readonly pattern: "(https|s3|bank):\\/\\/.+";
                readonly examples: readonly ["bank://lively"];
            };
            readonly script: {
                readonly anyOf: readonly [{
                    readonly description: "Text script contains an input text to be spoken by the actor";
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly limit: {
                    ...
                    readonly maximum: 1.7976931348623157e+308;
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "pagination - the amount of actors to return";
                };
                readonly token: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                ...
                readonly actors: {
                    readonly items: {
                        readonly properties: {
                            readonly id: {
                                readonly type: "string";
                                readonly description: "The id of the actor";
                                readonly examples: readonly ["amy"];
                            };
                            readonly gender: {
                                readonly type: "string";
                            ...
                            readonly image_url: {
                                readonly type: "string";
                                readonly description: "High resolution image of the actor";
                            };
                            readonly thumbnail_url: {
                                readonly type: "string";
                                readonly description: "A low resolution image representing the actor";
                            };
                        };
                        readonly required: readonly ["id", "gender", "created_at", "modified_at", "image_url", "thumbnail_url"];
                        readonly type: "object";
                        readonly additionalProperties: false;
                    };
                    readonly type: "array";
...
export { AddIceCandidate, CreateAnimation, CreateClip, CreateStream, CreateTalk, CreateTalkStream, CreateTask, DeleteAnimation, DeleteClip, DeleteStream, DeleteTalk, GetActorDrivers, GetActors, GetAnimation, GetAnimations, GetClip, GetClips, GetPresenterById, GetPresenterDriversById, GetPresenters, GetTalk, GetTalks, StartConnection };
